...
<html lang="en">
    ...
    <body>
        ...
        <section id="do_action">
            <div class="container">
                <div class="heading">
                    <h3>Total price of all product</h3>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="total_area">
                            <ul>
                                <li>Cart Sub Total <span>${requestScope.totalPrice} VND</span></li>
                                <li>Eco Tax <span>0 VND</span></li>
                                <li>Shipping Cost <span>30000 VND</span></li>
                                <li>Total <span>${requestScope.totalPrice + 30000} VND</span></li>
                            </ul>
